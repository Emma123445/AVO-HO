  ...
  return (
    <div className="productDisplay">
      ...
      <div className="productdisplay-right">
        ...
        <button onClick={()=>{addToCart(product.id)}}>Ajouter une carte</button>
        <p className="productdisplay-right-category"><span>Categorie : </span>Woman, pagne, Crop Top</p>
        <p className="productdisplay-right-category"><span>Tags : </span>Moderne, latest</p>
      </div>
    </div>
  );
};
